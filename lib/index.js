...
function _createFileMD() {
  ...
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee2(projectPath, basePath, fileNames) {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            paths = util.findFilePath(projectPath, fileNames);
            doActions = [], mdPaths = [];
...
function _createMD() {
  ...
  _regenerator["default"].mark(function _callee3(basePath) {
    var srcPath, docConfig, _ref2, _ref3, shareCtrMDPaths, ctrMDPaths;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            docConfig = require(path.join(basePath, 'doc.config.js'));
            _context3.next = 4;
            return Promise.all([createFileMD(srcPath, basePath, docConfig.shareCtrNames || ["BaseController.js"]), createFileMD(srcPath, basePath, docConfig.pageCtrNames || ["controller.js"])]);

          case 4:
            _ref2 = _context3.sent;
            _ref3 = (0, _slicedToArray2["default"])(_ref2, 2);
            shareCtrMDPaths = _ref3[0];
            ctrMDPaths = _ref3[1];
            _context3.next = 10;
            return util.writeFile(basePath, "README.md", template({
              basePath: basePath,
              ctrMDPaths: ctrMDPaths,
              shareCtrMDPaths: shareCtrMDPaths
            }));
